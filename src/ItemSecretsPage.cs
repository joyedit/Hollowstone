...
namespace Hollowstone
{
    ...
    // that's the game. Pages without a seal (e.g. spawned in creative) bind
    // lazily to the first player seen holding them (LockboxRegistry does that
    // server-side).
    public class ItemSecretsPage : Item
    {
        ...
        public override string GetHeldItemName(ItemStack itemStack)
        {
            ...
            return Lang.Get("hollowstone:secretspage-owned", owner);
        }
        ...
        public override void GetHeldItemInfo(ItemSlot inSlot, StringBuilder dsc, IWorldAccessor world, bool withDebugInfo)
        {
            ...
            if (owner != null)
            {
                dsc.AppendLine(Lang.Get("hollowstone:secretspage-sealedby", owner));
            }
        }
    }
}
